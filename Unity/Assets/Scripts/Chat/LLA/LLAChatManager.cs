...
public class LLAChatManager : MonoBehaviour
{
    ...
    void Start()
    {
        CHAT_DELAY = GameplayManager.ChatDelay;
        listOfPeopleGUI = GameObject.Find("List of People");
        listOfPeopleGUI.SetActive(false);

        currentLocation = GameObject.Find("GameplayManager").GetComponent<GameplayManager>().CurrentLocation;
    }
